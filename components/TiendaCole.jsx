...
export default function TiendaCole() {
  ...
  function renderProductImage(product, large = false) {
    ...
    return (
      <div className={large ? "cole-img-frame cole-img-frame-large" : "cole-img-frame"}>
        <img
          src={src}
          ...
          style={{
            ...
            width: "auto",
            height: "auto",
            maxWidth: large ? "92%" : "82%",
            maxHeight: large ? "92%" : "82%",
            objectFit: "contain",
